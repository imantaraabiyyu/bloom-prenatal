...
// Mood picker deliberately kept as emoji (not converted to lucide-react
// icons like the rest of the app's redesign) -- moods are expressive/
// emotional, and emoji read as "which feeling" far more immediately than
// an abstract line-icon would; confirmed with the user after seeing the
// icon version rendered live.
export const MOODS = [
